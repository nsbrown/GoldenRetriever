...
public class Backup {
	public static void main(String[] aArgs) throws IOException {
		...
		// System.out.println("Time to Copy in seconds = " + ((System.nanoTime()
		// - start))/1000000000);

	}

	public static String fileExtentionChanger(File folder) // Borrowed:
															// http://stackoverflow.com/questions/30187581/java-getting-file-name-without-extension-from-a-folder
	{ // Modified by Earl
	...
	private static void createPath(File targetDir) // If directory does not
													// exist it creates it.
	{
